...
<body class="bg-gradient-primary">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-7">
                        <div class="p-5">
                            ...
                            <form class="user" method="POST" action="<?php echo URL ?>Admin/registerAction">
                                <div class="form-group row">
                                    <div class="col-sm-6 mb-3 mb-sm-0">
                                        <input name = "ho" type="text" class="form-control form-control-user" id="exampleFirstName" placeholder="First Name">
                                    </div>
                                    <div class="col-sm-6">
                                        <input name="ten" type="text" class="form-control form-control-user" id="exampleLastName" placeholder="Last Name">
                                    </div>
                                </div>
                                ...
                                <button name="adminRegister" type="submit" class="btn btn-primary btn-user btn-block">
                                    Register
                                </button>
                            </form>
                            <hr>
                            <div class="text-center">
                                <a class="small" href="<?php echo URL ?>Admin/login">Already have an account? Login!</a>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <script src="<?php echo URL ?>mvc/assets/TableFile/vendor/bootstrap/js/bootstrap.bundle.min.js"></script>
